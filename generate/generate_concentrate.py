...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', default='/home/nfs02/xingsy/code/output/concentrate/temp.txt')
    ...
    with open(output_file, "a+") as f:
        with open(file_path, 'r', encoding='utf-8') as file:
            for line in tqdm(file, desc="Processing", unit=" lines"):  # 使用 tqdm 包装文件迭代
                ...
                image_path = '/home/nfs02/xingsy/code/data/MNRE/mnre_image/img_org/new_concentrate/' + data['img_id']
